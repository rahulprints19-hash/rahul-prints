      ...
      <div style="max-width:700px; margin:0 auto; background:#ffffff; border-radius:24px; overflow:hidden; border:1px solid #dbe7ff;">
        ...
        <div style="padding:28px 32px 32px;">
          ...
          <div style="background:#f8fbff; border:1px solid #dbe7ff; border-radius:18px; padding:20px; margin-bottom:18px;">
            ...
            <p style="margin:0 0 8px;"><strong>UPI ID:</strong> ${escapeHtml(order.payment.payerUpiId || "NA")}</p>
            <p style="margin:0 0 8px;"><strong>Transaction ID:</strong> ${escapeHtml(order.payment.transactionId || "NA")}</p>
            <p style="margin:0;"><strong>Date & Time:</strong> ${escapeHtml(formatDateTime(order.payment.paidAt))}</p>
          </div>
    ...
    <div style="font-family:Arial,sans-serif; color:#10213d; max-width:760px; margin:0 auto;">
      ...
      <div style="background:#ffffff; border:1px solid #dbe7ff; border-top:0; border-radius:0 0 24px 24px; padding:28px 30px;">
        <div style="background:#f8fbff; border:1px solid #dbe7ff; border-radius:18px; padding:20px; margin-bottom:18px;">
          ...
          <p><strong>UPI ID:</strong> ${escapeHtml(order.payment.payerUpiId || "NA")}</p>
          <p><strong>Transaction ID:</strong> ${escapeHtml(order.payment.transactionId || "NA")}</p>
          <p><strong>Date & Time:</strong> ${escapeHtml(formatDateTime(order.payment.paidAt))}</p>
