...
5. Configure Razorpay and business details
   ...
   Optional: keep `UPI_ID` only as a hidden legacy fallback
...
9. Test before going live
   ...
   Open Razorpay Checkout on desktop
   Open Razorpay Checkout on Android
   Open Razorpay Checkout on iPhone
   Complete one real `₹1` or test-mode payment
